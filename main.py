...
def parse_args():
    ...
    parser.add_argument("--log_interval", type=int, default=20, help="log result per interval interval")
    ...
    parser.add_argument("--early_stop", type=int, default=2, help="max time step of answer sequence")
